        ...
        <div className="flex flex-col items-center justify-start min-h-screen w-full px-4 
          ...
          <div className="mt-8 lg:mt-0">
            <img
              src={product.image}
              alt={product.name}
              className="w-56 sm:w-64 lg:w-[500px] lg:h-[300px] rounded-2xl border border-gray-200 shadow-sm object-contain"
            />
          </div>
          ...
          <div className="mt-12 text-center lg:mt-0 lg:text-left">
            ...
            <p className="mt-3 text-lg lg:text-2xl font-bold text-gray-900">
              Price: ${product.price}
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mt-6 items-center justify-center lg:justify-start w-full">

              <button className="bg-gray-900 text-white font-semibold w-44 h-12 rounded-xl shadow-sm 
                                 hover:bg-gray-800 transition-colors duration-200 uppercase text-xs tracking-widest">
                Add to cart
              </button>

              <Link to={`/checkout-product/${id}`}>
                <button className="bg-white text-gray-900 border border-gray-300 font-semibold w-44 h-12 rounded-xl shadow-sm 
                                   hover:bg-gray-100 transition-colors duration-200 uppercase text-xs tracking-widest">
                  Buy Now
                </button>
              </Link>
            ...
            <div className="mt-8 space-y-3 text-gray-600 font-medium text-sm">
              ...
              <p className="flex items-center gap-3">
                <FaShippingFast className="text-gray-900 text-lg" /> Fastest Delivery (1-3 days)
              </p>

              <p className="flex items-center gap-3">
                <FaShieldAlt className="text-gray-900 text-lg" /> Branded Warranty
              </p>

              <p className="flex items-center gap-3">
                <FaBoxOpen className="text-gray-900 text-lg" /> 100% Genuine Product with Original Boxing
              </p>

              <p className="flex items-center gap-3">
                <FaMoneyBillWave className="text-gray-900 text-lg" /> Cash On Delivery
              </p>
